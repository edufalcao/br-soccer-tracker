...
<template>
  <div
    class="animate-fade-in flex flex-col items-center justify-center rounded-lg border border-pitch-100 bg-pitch-50/50 py-12 text-center pitch-sideline"
  >
    <!-- Soccer ball icon -->
    ...
    <p class="text-sm text-pitch-600">{{ message }}</p>
